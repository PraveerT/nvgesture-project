...
class DTNNet(nn.Module):
    def __init__(self, args, num_classes=249, inp_dim=512, dim_head=64, hidden_dim=768,
        ...
        if args.epochs > warmup_temp_epochs:
            ...
            # If total epochs is less than warmup epochs, just use linear schedule
            self.temp_schedule = np.linspace(warmup_temp, temp, args.epochs)
